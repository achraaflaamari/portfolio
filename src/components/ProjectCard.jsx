        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          {project.githubUrl && (
            <button 
              ...
              className="flex items-center gap-2 bg-gray-800/80 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-700/80 transition-all duration-200 hover:scale-105 border border-gray-600/50"
            >
          ...
          {project.liveUrl && (
            <button 
              ...
              className="flex items-center gap-2 bg-white text-gray-900 px-4 py-2 rounded-lg font-medium hover:bg-white/90 transition-all duration-200 hover:scale-105 hover:shadow-lg"
            >
